...
const createAsset = async (req, res, next) => {
  try {
    ...
    console.log(result);
    res.status(201).json({
      message: "The operation 'Create Asset' was successfully",
      data: result,
    });
  } catch (err) {
    const error = new HttpError(
...
const deleteAsset = async (req, res, next) => {
  try {
    ...
    if (!asset) {
      return res.json({
        message: "the asset whose you want to delete doesnt exists",
        code: 404,
      });
    }
...
const updateAsset = async (req, res, next) => {
  try {
    ...
    res
      .status(200)
      .json({ result, message: "the asset was updated succesfully!", result });
...
const getAssetById = async (req, res, next) => {
  try {
    ...
    if (!asset) {
      return res.json({
        message: "the asset whose you want to get does not exists",
        code: 404,
      });
    }
    res
...
const getAssetsByEmployeeId = async (req, res, next) => {
  try {
    ...
    if (!emp) {
      return res.json({
        message:
          "The assets what you want get are associating an employee who does not exist. Review the id_employee",
        code: 404,
      }); //404
    }
